                    ...
                    messagesDummyData.map((msg, index) => (
                        <div key={index} className={`flex items-end gap-2 justify-end ${msg.senderId !== '680f50e4f10f3cd28382ecf9' && 'flex-row-reverse'}`}>
                            ...
                            border-gray-700 rounded-lg overflow-hidden mb-8'/>
                                ...
                                bg-violet-500/30 text-white ${msg.senderId === '680f50e4f10f3cd28382ecf9' ? 'rounded--br-none' :
                                            'rounded-bl-none'
                                        }`}>{msg.text}</p>
                                )
                            }
                            <div className='text-center text-xs'>
                                <img src={msg.senderId === '680f50e4f10f3cd28382ecf9' ? assets.avatar_icon : assets.profile_martin} alt="avater" className='w-7 rounded-full' />
